...
const CHAIN := [
    ...
    {"id": "un-posto-per-due", "title": "Un posto per due", "letter_text": "Un tavolo apparecchiato per uno fa un po' di malinconia.\nMetti un tavolino e due sedie:\nprima o poi qualcuno verrà a sedersi di fronte a te.", "hint": "un tavolino e almeno 2 sedie", "done_text": "Due sedie una di fronte all'altra. Ho già in mente chi potrebbe riempirne una.", "predicate": {"type": "table_with_chairs", "chairs": 2}, "unlocks": ["Camino", "Lampada", "Lampada semplice"], "celebrate_letter": ""},
    {"id": "il-fuoco-e-la-luce", "title": "Il fuoco e la luce", "letter_text": "Quando cala il buio, un villaggio si riconosce da come si illumina.\nAccendi un camino e appendi una lampada:\ndue piccole luci bastano a dire «qui c'è vita».", "hint": "due piccole luci accese", "done_text": "Da quassù vedo le tue luci: sembrano un piccolo faro tra gli alberi.", "predicate": {"type": "any_count", "names": ["Camino", "Lampada", "Lampada semplice"], "n": 2}, "unlocks": ["Letto", "Libreria"], "celebrate_letter": ""},
...
const DESIDERI := [
    ...
    # ---- inverno
    {"id": "luci-nella-neve", "season": 3, "title": "Respiri dorati", "letter_text": "La neve spegne i colori, non i cuori.\nAccendi cinque luci tra camini, lampade e lampioni:\nvoglio vedere il villaggio respirare vapore dorato.", "hint": "cinque luci accese tra camini, lampade e lampioni", "done_text": "Cinque respiri di luce nella neve. Da quassu' sembrate un presepe.", "predicate": {"type": "any_count", "names": ["Camino", "Lampada", "Lampada semplice", "Lampione"], "n": 5}, "stars": 2, "gift_piece": ""},
